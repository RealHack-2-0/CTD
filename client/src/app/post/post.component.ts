...
socket;
  constructor(private http:HttpClient,public router: Router, public route: ActivatedRoute, public service: RegserviceService, private flashMessage: FlashMessagesService) {
    // this.socket = io();
  }
  public id;
  post;
...
public ra={
 ...
 rightAnsw(id,cId){
  ...
  this.ra.id=id;
  this.ra._id=cId;
  this.service.rightAnsw(this.ra).subscribe(res=>{
console.log(res)
this.ngOnInit()
  })
 }
